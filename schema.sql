...
insert into services (name, price, duration_minutes, description, sort_order) values
  ('Мужская стрижка',                1200, 60,  null, 1),
  ('Стрижка машинкой (одна насадка)',  800, 60,  null, 2),
  ('Детская стрижка (до 12 лет)',     1000, 60,  null, 3),
  ('Комплекс (стрижка + борода)',     2000, 120, null, 4),
  ('Камуфляж — голова',              1200, 60,  'Американ Крю', 5),
  ('Камуфляж — борода',               900, 40,  'Американ Крю', 6),
  ('Камуфляж Кондор — голова',        900, 60,  null, 7),
  ('Камуфляж Кондор — борода',        700, 40,  null, 8),
  ('Бритьё шейвером',                 900, 40,  null, 9),
  ('Бритьё опасной бритвой',         1100, 40,  null, 10),
  ('Удаление волос воском — уши/нос', 350, 15,  null, 11),
  ('Удаление волос воском — затылок', 500, 20,  null, 12),
  ('Удаление волос воском — шея',     600, 20,  null, 13),
  ('Архитектура бровей',              400, 20,  null, 14),
  ('Укладка',                         700, 20,  null, 15),
  ('Массаж лица',                     800, 20,  null, 16),
  ('Массаж головы',                   600, 20,  null, 17),
  ('Маска',                           600, 20,  null, 18),
  ('Моделирование бороды',           1000, 40,  null, 19),
  ('Химическая завивка',             6000, 180, null, 20),
  ('Стрижка насадками',              1000, 60,  null, 21),
  ('Маникюр',                        1400, 45,  null, 22),
  ('Комплексный премиум уход для лица', 2000, 60, 'Распаривание, скрабирование, маска, массаж, патчи, увлажнение', 23);

-- 4. КОНКРЕТНЫЕ ВЫХОДНЫЕ ДНИ (когда мастер не работает в обычно рабочий день)
...
create policy "days_off_all" on days_off for all using (true) with check (true);
